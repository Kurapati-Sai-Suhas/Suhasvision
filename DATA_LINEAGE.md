...
- **Evaluation baseline to cite:** 5-fold identity-grouped CV, overall MAE **11.56 ± 1.76** vs. constant-mean baseline 13.59 (`EVALUATION_RESULTS.md`, 2026-07-18; fold-level detail in `cv_results_t1a_step7.json`). This is the number any post-change re-evaluation must be compared against.
